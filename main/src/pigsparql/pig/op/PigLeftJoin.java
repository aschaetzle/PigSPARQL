...
import pigsparql.sparql.ExprTranslator;
...
public class PigLeftJoin extends PigOp2 {
    ...
    private String generateLeftJoin() {
        ...
        filter = translator.translate(current, expandPrefixes);
        while (iterator.hasNext()) {
            current = iterator.next();
            filter += " AND " + translator.translate(current, expandPrefixes);
        }
