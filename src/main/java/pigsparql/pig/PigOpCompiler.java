 ...
 * before using the PigOpCompiler.
 *
 * @see pigsparql.sparql.AlgebraTransformer
 */
public class PigOpCompiler extends PigOpVisitorBase {
    ...
    /**
     * Constructor of class PigOpCompiler.
     */
    public PigOpCompiler() {
        countBGP = 0;
        countJoin = 0;
        countLeftJoin = 0;
        countUnion = 0;
     ...
     */
    public String translate(PigOp op) {
