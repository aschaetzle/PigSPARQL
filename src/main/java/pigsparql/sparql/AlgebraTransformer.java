...
import pigsparql.pig.op.PigBGPBase;
import pigsparql.pig.op.PigBGPVP;
...
public class AlgebraTransformer extends OpVisitorBase {
    ...
    private final Stack<PigOp> stack;
    ...
    public void visit(OpBGP opBGP) {
    	if (Tags.verticalPartitioning)
    		stack.push(new PigBGPVP(opBGP, prefixes));
    	else
    		stack.push(new PigBGPBase(opBGP, prefixes));
    }
