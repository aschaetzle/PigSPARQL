...
-- BGP
f0 = FILTER indata BY p == '<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#takesCourse>'
                  AND o == '<http://www.Department0.University0.edu/GraduateCourse0>' ;
t0 = FOREACH f0 GENERATE s AS x ;

f1 = FILTER indata BY p == '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'
                  AND o == '<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#GraduateStudent>' ;
