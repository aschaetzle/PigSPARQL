...
SET job.name 'BSBM Q1 ON $inputData' ;
...
BGP1 = JOIN t4 BY product, t2 BY product, t3 BY product, t5 BY product, t1 BY product ;
...
-- SM_Order
SM_Order = ORDER SM_Distinct BY label PARALLEL $reducerNum ;
