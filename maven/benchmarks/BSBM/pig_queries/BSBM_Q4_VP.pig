...
SET job.name 'BSBM Q4 ON $inputData' ;
...
BGP1 = JOIN t2 BY product, t3 BY product, t1 BY product, t4 BY product, t5 BY product, t0 BY product ;
...
t5 = FOREACH f5 GENERATE s AS product ;
BGP2 = JOIN t2 BY product, t3 BY product, t1 BY product, t4 BY product, t5 BY product, t0 BY product ;
