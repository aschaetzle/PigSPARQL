...
-- BGP
f0 = FILTER indata BY s == '<http://www.University0.edu>'
                  AND p == '<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#hasAlumnus>' ;
t0 = FOREACH f0 GENERATE o AS x ;

f1 = FILTER indata BY p == '<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'
                  AND o == '<http://www.lehigh.edu/~zhp2/2004/0401/univ-bench.owl#Person>' ;
