...
BGP2 = JOIN BGP1 BY z, t2 BY z PARALLEL $reducerNum ;
BGP2 = FOREACH BGP2 GENERATE BGP1::y AS y, BGP1::z AS z ;

BGP3 = JOIN t3 BY z, BGP2 BY z PARALLEL $reducerNum ;
BGP3 = FOREACH BGP3 GENERATE t3::x AS x, BGP2::y AS y, BGP2::z AS z ;

BGP4 = JOIN BGP3 BY x, t4 BY x PARALLEL $reducerNum ;
BGP4 = FOREACH BGP4 GENERATE BGP3::x AS x, BGP3::y AS y, BGP3::z AS z ;

BGP5 = JOIN t5 BY (x,y), BGP4 BY (x,y) PARALLEL $reducerNum ;
