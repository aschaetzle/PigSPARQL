...
BGP2 = FOREACH BGP2 GENERATE $0 AS z, $1 AS y ;

BGP3 = JOIN BGP2 BY y, t3 BY y PARALLEL $reducerNum ;
BGP3 = FOREACH BGP3 GENERATE $0 AS z, $1 AS y, $2 AS x ;

BGP4 = JOIN BGP3 BY x, t4 BY x PARALLEL $reducerNum ;
BGP4 = FOREACH BGP4 GENERATE $0 AS z, $1 AS y, $2 AS x ;

BGP5 = JOIN BGP4 BY (x,z), t5 BY (x,z) PARALLEL $reducerNum ;
BGP5 = FOREACH BGP5 GENERATE $0 AS z, $1 AS y, $2 AS x ;
