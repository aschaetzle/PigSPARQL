...
BGP1 = JOIN t3 BY x, t4 BY x PARALLEL $reducerNum ;
BGP1 = FOREACH BGP1 GENERATE t3::x AS x, t3::z AS z ;

BGP2 = JOIN BGP1 BY x, t5 BY x PARALLEL $reducerNum ;
BGP2 = FOREACH BGP2 GENERATE BGP1::x AS x, t5::y AS y, BGP1::z AS z ;

BGP3 = JOIN BGP2 BY (y,z), t1 BY (y,z) PARALLEL $reducerNum ;
BGP3 = FOREACH BGP3 GENERATE BGP2::x AS x, BGP2::y AS y, BGP2::z AS z ;

BGP4 = JOIN BGP3 BY z, t2 BY z PARALLEL $reducerNum ;
BGP4 = FOREACH BGP4 GENERATE BGP3::x AS x, BGP3::y AS y, BGP3::z AS z ;

BGP5 = JOIN BGP4 BY y, t0 BY y PARALLEL $reducerNum ;
BGP5 = FOREACH BGP5 GENERATE BGP4::x AS x, BGP4::y AS y, BGP4::z AS z ;


-- store results into output
STORE BGP5 INTO '$outputData' USING PigStorage(' ') ;
