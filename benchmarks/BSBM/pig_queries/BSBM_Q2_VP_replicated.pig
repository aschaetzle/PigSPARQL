...
SET job.name 'BSBM Q2 replicated ON $inputData' ;
...
BGP1_0 = JOIN t0 BY product, t1 BY product, t2 BY product, t5 BY product, t7 BY product, t8 BY product, t9 BY product, t10 BY product, t11 BY product USING 'replicated' ;
...
BGP1_1 = JOIN t3 BY p, t4 BY p, BGP1_0 BY p USING 'replicated' ;
...
BGP1_2 = JOIN t6 BY f, BGP1_1 BY f USING 'replicated' ;
...
OPT1 = JOIN BGP1 BY product LEFT OUTER, BGP2 BY product USING 'replicated' ;
...
OPT2 = JOIN OPT1 BY product LEFT OUTER, BGP3 BY product USING 'replicated' ;
...
OPT3 = JOIN OPT2 BY product LEFT OUTER, BGP4 BY product USING 'replicated' ;
