...
SET job.name 'BSBM Q5 replicated ON $inputData' ;
...
BGP1 = JOIN t1 BY productXYZ, t5 BY productXYZ, t3 BY productXYZ USING 'replicated' ;
...
-- JOIN
j1 = JOIN BGP2 BY prodFeature, BGP1 BY prodFeature USING 'replicated' ;
